...
Chapter 1 was about **clarity before code**. You named your product (or picked a placeholder), read what FreshMarket is for, checked prerequisites, and learned how this course gates progress — finish one chapter's checklist before opening the next. You may have written `learning-log/01-introduction.md`. None of that required a running app; it required you to understand *what* you are building and *how* the course expects you to work.
...
| A `learning-log/01-introduction.md` (hopefully committed) | A running API or React app |
